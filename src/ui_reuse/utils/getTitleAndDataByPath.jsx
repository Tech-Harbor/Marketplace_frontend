export const getTitleAndDataByPath = currentPage => {
  switch (currentPage) {
    case '/mobiles':
      return {
    ...
    case '/games':
      return {
        title: 'Ігрові приставки та пристрої',
        dataToShow: [
          {
            id: 50,
